...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-300 flex flex-col">
      ...
      <main className={`container mx-auto px-4 py-4 relative ${loading ? 'flex-1' : ''}`}>
        {loading ? (
          <Loader />
        ) : error ? (
      ...
      <footer className={`bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 ${loading ? 'mt-0 sticky bottom-0' : 'mt-12'}`}>
